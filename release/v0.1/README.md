# Magnetar v0.1 Release Evidence

Date: 2026-08-27
Status: release-candidate evidence bundle for the `codex/build-issues` PR.

This directory materializes the v0.1 release-policy evidence into repository
...
The v0.1 statement is a CPU-local inference runtime baseline. CUDA, Metal,
