...
**Status: engine prerequisite, WIT interface design, and the Runtime-side graph-builder capability all landed; not yet wired into first_native_runtime.rs or exercised by a real Component.**
