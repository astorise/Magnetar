...
**Status: engine prerequisite, WIT interface design, the Runtime-side graph-builder capability, and the first real Qwen Component all landed and proven end to end; not yet wired into first_native_runtime.rs's production path (task 11.5).**
