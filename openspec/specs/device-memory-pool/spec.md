# device-memory-pool Specification

## Purpose
TBD - created by archiving change define-device-memory-pool-and-allocation-planner-contract. Update Purpose after archive.
## Requirements
