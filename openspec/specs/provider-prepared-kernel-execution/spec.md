# provider-prepared-kernel-execution Specification

## Purpose
TBD - created by archiving change define-provider-prepared-kernel-execution-contract. Update Purpose after archive.
## Requirements
