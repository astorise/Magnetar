# kernel-artifact-manifest Specification

## Purpose
This specification defines the portable Kernel Artifact Manifest exchange format: versioned canonical JSON schema, content-addressed artifact references, portable Operator semantic binding, explicit specialization, non-authoritative trust/recommendation/qualification metadata, and the absence of process-local Prepared Kernel state or execution side effects during parsing.
## Requirements
