...
requests, discussions, and any other Magnetar-run forum), and also applies
...
[private security advisory](https://github.com/astorise/Magnetar/security/advisories/new)
(the mechanism this repository already has for a confidential report -- see
[SECURITY.md](SECURITY.md)) or by contacting the maintainer directly through
